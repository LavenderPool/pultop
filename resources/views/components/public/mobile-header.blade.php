...
<span class="menu-text">Банки</span>
</span>
</a>
...
<span class="menu-item-text">
<span class="menu-text">Кредиты</span>
</span>
</a>
<ul class="sub-nav gradient-hover hover-style-bg level-arrows-on">
...
<span class="menu-item-text">
<span class="menu-text">Вклады</span>
</span>
</a>
</li>
...
<a href="{{ route('gold.show') }}" data-level='1'>
<span class="menu-item-text">
<span class="menu-text">Золото</span>
</span>
</a>
</li>
...
<ul class="sub-nav gradient-hover hover-style-bg level-arrows-on">
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1996 first depth-1">
<a href="{{ route('calculators.credit') }}" data-level='2'>
<span class="menu-item-text">
<span class="menu-text">Кредитный калькулятор</span>
</span>
</a>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1971 depth-1">
<a href="{{ route('calculators.deposit') }}" data-level='2'>
<span class="menu-item-text">
<span class="menu-text">Калькулятор Вкладов</span>
</span>
</a>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1990 depth-1">
<a href="{{ route('calculators.mortgage') }}" data-level='2'>
<span class="menu-item-text">
<span class="menu-text">Калькулятор Ипотеки</span>
</span>
</a>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1970 depth-1">
<a href="{{ route('calculators.autoloan') }}" data-level='2'>
<span class="menu-item-text">
<span class="menu-text">Калькулятор Автокредита</span>
</span>
</a>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1972 depth-1">
<a href="{{ route('calculators.vat') }}" data-level='2'>
<i class="fa fa-sign-out">
</i>
<span class="menu-item-text">
<span class="menu-text">Калькулятор НДС</span>
</span>
</a>
</li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1995 depth-1">
