                    ...
                    <div class="mini-nav">
                        <ul id="bottom-menu">
                            <li
                                ...
                                <ul class="footer-sub-nav gradient-hover hover-style-bg level-arrows-on">
                                    ...
                                    <li
                                        ...
                                        <a href="/ofitsialnyj-kurs-valyut/" data-level="2"><span
                                    ...
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4056 depth-1">
                                        <a href="/bankomaty-bankov-uzbekistana/" data-level="2"><span
                            ...
                            <li
                                ...
                                <ul class="footer-sub-nav gradient-hover hover-style-bg level-arrows-on">
                                    <li
                                        ...
                                        <a href="/potrebitelskie-krediti/" data-level="2"><span
                                                class="menu-item-text"><span
                                    ...
                                    <li
                                        ...
                                        <a href="/avtokredity-v-uzbekistane/" data-level="2"><span
                                                class="menu-item-text"><span
                                    ...
                                    <li
                                        ...
                                        <a href="/ipotechnye-kredity-v-uzbekistane/"
                                    ...
                                    <li
                                        ...
                                        <a href="/bankovskie-mikrozajmy-v-uzbekistane/"
                                            data-level="2"><span class="menu-item-text"><span
                                    ...
                                    <li
                                        ...
                                        <a href="/overdraft-v-uzbekistane/" data-level="2"><span
                                                class="menu-item-text"><span
                                    ...
                                    <li
                                        ...
                                        <a href="/kredity-nachinayushhim-biznesmenam-v-uzbekistane/"
                                            data-level="2"><span class="menu-item-text"><span
                                    ...
                                    <li
                                        ...
                                        <a href="/obrazovatelnye-kredity-v-uzbekistane/"
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2219 depth-0">
                                <a href="/sravnenie-bankovskih-kart/" data-level="1"><i
                            ...
                            <li
                                ...
                                <a href="#" data-level="1"><span class="menu-item-text"><span
                                            class="menu-text">Ещё…</span></span></a>
                                <ul class="footer-sub-nav gradient-hover hover-style-bg level-arrows-on">
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4352 first depth-1">
                                        <a href="/strahovye-kompanii-uzbekistana/" data-level="2"><span
                                                class="menu-item-text"><span class="menu-text">Страховые компании
                                                    Узбекистана</span></span></a></li>
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4353 depth-1">
                                        <a href="/rejting-strahovyh-kompanij-uzbekistana/"
                                            data-level="2"><span class="menu-item-text"><span class="menu-text">Рейтинг
                                                    страховых компаний Узбекистана</span></span></a></li>
                                </ul>
                            </li>
                        </ul>
                        <div class="menu-select"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <option value="/ofitsialnyj-kurs-valyut/" data-level="2">— Официальный
                                    курс ЦБ</option>
                                <option value="/kurs-obmena-valyut/" data-level="2">— Обменный курс
                                    банков</option>
                                <option value="/kurs-obmena-valyut/usd/" data-level="3">—— Доллар США
                                </option>
                                <option value="/kurs-obmena-valyut/eur/" data-level="3">—— Евро
                                </option>
                                <option value="/kurs-obmena-valyut/rub/" data-level="3">—— Российский
                                    рубль</option>
                                <option value="/kurs-obmena-valyut/kzt/" data-level="3">—— Казахский
                                    тенге</option>
                                <option value="/kurs-obmena-valyut/gbp/" data-level="3">—— Фунт
                                    стерлингов</option>
                                <option value="/kurs-obmena-valyut/chf/" data-level="3">—— Швейцарский
                                    франк</option>
                                <option value="/kurs-obmena-valyut/jpy/" data-level="3">—— Иена
                                </option>
                                <option value="/bankomaty-bankov-uzbekistana/" data-level="2">—
                                    Банкоматы банков Узбекистана</option>
                                <option value="/vse-kredity-uzbekistana/" data-level="1">Кредиты
                                </option>
                                <option value="/potrebitelskie-krediti/" data-level="2">—
                                    Потребительский</option>
                                <option value="/avtokredity-v-uzbekistane/" data-level="2">— Автокредит
                                </option>
                                <option value="/ipotechnye-kredity-v-uzbekistane/" data-level="2">—
                                    Ипотека</option>
                                <option value="/bankovskie-mikrozajmy-v-uzbekistane/" data-level="2">—
                                    Банковские микрозаймы</option>
                                <option value="/overdraft-v-uzbekistane/" data-level="2">— Овердрафт
                                </option>
                                <option value="/kredity-nachinayushhim-biznesmenam-v-uzbekistane/"
                                    data-level="2">— Предпринимателям</option>
                                <option value="/obrazovatelnye-kredity-v-uzbekistane/" data-level="2">—
                                    На образование</option>
                                <option value="/vkladi/" data-level="1">Вклады</option>
                                <option value="/sravnenie-bankovskih-kart/" data-level="1">Карты
                                </option>
                                ...
                                <option value="#" data-level="1">Ещё…</option>
                                <option value="/strahovye-kompanii-uzbekistana/" data-level="2">—
                                    Страховые компании Узбекистана</option>
                                <option value="/rejting-strahovyh-kompanij-uzbekistana/"
                                    data-level="2">— Рейтинг страховых компаний Узбекистана</option>
